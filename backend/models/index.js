...
DocumentPermission.belongsTo(Document, { foreignKey: 'document_id', as: 'document' });

User.hasMany(DocumentPermission, { foreignKey: 'user_id', as: 'document_permissions' });
DocumentPermission.belongsTo(User, { foreignKey: 'user_id', as: 'user' });

Comment.belongsTo(models.Document, { foreignKey: "document_id", as: "document" });
Comment.belongsTo(models.DocumentVersion, { foreignKey: "version_id", as: "version" });
