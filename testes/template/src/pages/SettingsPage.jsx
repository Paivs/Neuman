    ...
    const SettingsPage = () => {
      return (
        ...
        >
          ...
          <SettingsSection title="Perfil" icon={<UserCircle className="w-7 h-7 text-purple-400" />}>
            <div className="space-y-4">
              <div>
                <label htmlFor="name" className="block text-sm font-medium text-slate-300 mb-1">Nome Completo</label>
                <input type="text" id="name" defaultValue="Advogado Exemplo" className="w-full bg-slate-700/50 border border-slate-600 rounded-md p-2 focus:ring-2 focus:ring-purple-500 focus:border-purple-500 outline-none transition-colors" />
              </div>
              <div>
                <label htmlFor="email" className="block text-sm font-medium text-slate-300 mb-1">Email</label>
                <input type="email" id="email" defaultValue="advogado@example.com" className="w-full bg-slate-700/50 border border-slate-600 rounded-md p-2 focus:ring-2 focus:ring-purple-500 focus:border-purple-500 outline-none transition-colors" />
              </div>
          ...
          <SettingsSection title="Notificações" icon={<Bell className="w-7 h-7 text-purple-400" />}>
          ...
          <SettingsSection title="Segurança" icon={<Lock className="w-7 h-7 text-purple-400" />}>
             <div className="space-y-4">
              ...
              <p className="text-sm text-slate-400">Autenticação de dois fatores (2FA) está <span className="text-purple-400 font-semibold">Ativada</span>.</p>
            </div>
          </SettingsSection>
          
          <SettingsSection title="Aparência" icon={<Palette className="w-7 h-7 text-purple-400" />}>
            <p className="text-slate-300 mb-3">Tema da Interface:</p>
            <div className="flex space-x-3">
                <Button variant="outline" className="border-purple-500 text-purple-400 bg-purple-500/20">Escuro (Atual)</Button>
                <Button variant="outline" className="border-slate-600 text-slate-400 hover:bg-slate-700">Claro</Button>
            </div>
          </SettingsSection>
